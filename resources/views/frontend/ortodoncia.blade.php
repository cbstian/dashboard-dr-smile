                        ...
                        <div class="col-md-12 col-lg-6 text-center col-form order-2 order-md-2">
                            <div class="card shadow">
                                <div class="card-body py-3 py-md-4 px-3 px-md-5">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 text-start">
                                            <form>
                                                ...
                                                <div class="mb-3">
                                                    <input type="text" class="form-control border-0 servicios" readonly value="Instalación ortodoncia metálica">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 text-start">
                                            <h1  class="mb-0" style="font-weight: 800; font-size: 35px;"><span style="color:#D9A6E8; font-size:25px;">$</span>249.900</h1>
                                            <p style="color:#B2B2B2; font-weight: 800; font-size: 19px;">ANTES: $711.898</p>
                                        </div>
