...
@section('css_personalizado')
    ...
    <script>
        function gtag_report_conversion() {
            ...
            gtag('event', 'conversion', {'send_to': 'AW-366499281/HoSuCK_Ws6UDENGr4a4B'});
            return false;
        }
    </script>
@endsection
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 text-start">
                                            <form>
                                                ...
                                                <div class="mb-3">
                                                    <input type="text" class="form-control border-0 servicios" readonly value="Implante">
                                                </div>
                                                <div class="mb-3">
                                                    <input type="text" class="form-control border-0 servicios" readonly value="Corona">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
