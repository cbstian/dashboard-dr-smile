<div class="row landing-aside landing-aside--pink px-lg-5 mt-4">
...
<div class="row pe-4 mt-2 mt-sm-4">
    ...
    <div class="col-md-6 px-0 px-sm-3 text-center mb-4">
        <img src="{{ asset('images/Pay_drsmile.png') }}" class="img-fluid">
    </div>
    <div class="col-md-6 px-0 px-sm-3 text-center mb-4">
        <img src="{{ asset('images/icon_loction_r.png') }}" class="img-fluid">
    </div>
</div>
